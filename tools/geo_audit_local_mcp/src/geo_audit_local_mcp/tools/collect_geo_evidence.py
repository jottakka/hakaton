...
_COMPOUND_SLDS: frozenset[str] = frozenset({
    ...
    "co.il", "co.at", "co.th",
    "com.br", "com.au", "com.ar", "com.mx", "com.co", "com.sg", "com.my",
    "com.tr", "com.pe", "com.vn", "com.ph", "com.pk",
    "org.uk", "org.au", "org.nz", "net.uk", "net.au",
    "me.uk", "ltd.uk", "plc.uk",
    "gov.uk", "gov.au", "gov.br", "gov.in", "gov.sg",
    "edu.au", "edu.sg", "ac.uk", "ac.nz", "ac.jp", "ac.za",
})
...
async def collect_geo_evidence(
    ...
    discovered_domains: set[str] = {
        hostname
        for hostname in (urlparse(url).hostname for url in normalized_targets)
        if hostname
    }
...
def _get_base_domain(hostname: str) -> Optional[str]:
